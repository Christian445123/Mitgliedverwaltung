...
INSERT INTO admins (id, username, password_hash, role, must_change_password, created_at)
SELECT id, username, password_hash,
       IF(role = 'administrator', 'administrator', 'editor'),
       0, created_at
FROM admins_backup_csharp;

INSERT INTO members (id, jersey_nr, nachname, vorname, sz, bezirk, position, geburtsdatum, verein,
...
INSERT INTO member_camps (member_id, camp_1, spanien, camp_2, tschechien)
SELECT id,
...
INSERT INTO member_guardians (member_id, erz_name, erz_telefon, erz_email)
SELECT id, erziehungsberechtigter, erziehungsberechtigter_telefon, erziehungsberechtigter_email
FROM members_backup_csharp;

INSERT INTO member_consents (member_id, rechte_pflichten_akzeptiert, rechte_pflichten_am)
SELECT id, IF(rechte_pflichten_akzeptiert_at IS NULL, 0, 1), rechte_pflichten_akzeptiert_at
FROM members_backup_csharp;

INSERT INTO member_documents (member_id, sozialversicherungsnummer, nada_gueltig_bis, pass_foto_pfad,
...
INSERT INTO member_addresses (member_id, plz, ort, strasse)
SELECT id, plz, ort, strasse
FROM members_backup_csharp;

INSERT INTO member_equipment (member_id, essen, game_jersey_groesse, game_hosen_groesse, helm_groesse, helm_eigener,
...
INSERT INTO member_access (member_id, verify_token, access_password_hash, verified_at, failed_verify_attempts, verify_locked_until)
