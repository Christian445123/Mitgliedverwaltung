...
<fieldset>
    ...
    <div class="grid grid-2 checkbox-field">
        <label>
            <input type="checkbox" name="camp_1" value="1" <?= $checked('camp_1') ?>>
            Camp 1
        </label>
        <label>
            <input type="checkbox" name="spanien" value="1" <?= $checked('spanien') ?>>
            Spanien
        </label>
        <label>
            <input type="checkbox" name="camp_2" value="1" <?= $checked('camp_2') ?>>
            Camp 2
        </label>
        <label>
            <input type="checkbox" name="tschechien" value="1" <?= $checked('tschechien') ?>>
            Tschechien
        </label>
    </div>
</fieldset>
...
<fieldset>
    ...
    <div class="field">
        ...
        <?php if ($emailLocked): ?>
            ...
            <p class="hint">Diese Adresse ist über deinen Link festgelegt und kann hier nicht geändert werden.</p>
        <?php else: ?>
